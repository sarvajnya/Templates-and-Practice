'''
    ...
    Language: PyPy3
    created: 06.08.2024 20:09:22 IST
'''
import os
import sys
import math
...
if __name__ == '__main__':
    ...
    for _ in range(t):
        ...
        a = li()
        ans = 0
        if (a[0] > a[2] and a[1] > a[3]) or (a[0] > a[2] and a[1] == a[3]) or (a[0] == a[2] and a[1] > a[3]):
            ans += 1
        if (a[0] > a[3] and a[1] > a[2]) or (a[0] > a[3] and a[1] == a[2]) or (a[0] == a[3] and a[1] > a[2]):
            ans += 1
        if (a[1] > a[3] and a[0] > a[2]) or (a[1] > a[3] and a[0] == a[2]) or (a[1] == a[3] and a[0] > a[2]):
            ans += 1
        if (a[1] > a[2] and a[0] > a[3]) or (a[1] > a[2] and a[0] == a[3]) or (a[1] == a[2] and a[0] > a[3]):
            ans += 1
