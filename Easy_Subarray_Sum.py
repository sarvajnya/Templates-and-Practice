...
def main():
    ...
    for _ in range(t):
        ...
        if su<0:
            ...
            initial_max_sum = kadane(a)

            operations = 0

            modified_max_sum = initial_max_sum
            for i in range(n):
                if a[i] < 0:
                    original_value = a[i]
                    a[i] = 0
                    new_max_sum = kadane(a)
                    if new_max_sum > modified_max_sum:
                        modified_max_sum = new_max_sum
                        operations += 1
                    else:
                        a[i] = original_value
            output_list += [operations]
